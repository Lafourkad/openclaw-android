  ...
  static const List<RegistryPackage> catalog = [
    ...
    RegistryPackage(
      ...
      downloadUrls: [
        ...
        '$_alpineMain/libcares-1.34.5-r0.apk',
        '$_alpineMain/nghttp2-libs-1.64.0-r0.apk',
        '$_alpineMain/libidn2-2.3.7-r0.apk',
        '$_alpineMain/libpsl-0.21.5-r3.apk',
        '$_alpineMain/libzstd-1.5.6-r2.apk',
        '$_alpineMain/brotli-libs-1.1.0-r2.apk',
        '$_alpineMain/libunistring-1.3-r0.apk',
        '$_alpineMain/openssl-3.3.3-r0.apk',
      ],
      estimatedSize: '~5 MB', binaries: ['usr/bin/curl'],
    ),
    RegistryPackage(
      ...
      source: PackageSource.alpineMain,
      downloadUrls: [
        '$_alpineMain/wget-1.25.0-r0.apk',
        '$_alpineMain/libidn2-2.3.7-r0.apk',
        '$_alpineMain/libunistring-1.3-r0.apk',
      ],
      estimatedSize: '~1 MB', binaries: ['usr/bin/wget'],
    ),
    RegistryPackage(
